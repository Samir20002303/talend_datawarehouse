...
package datawarehouse_project.fact_table_0_1;
 ...
 * @status
 */
public class Fact_Table implements TalendJob {
	...
	private final String jobName = "Fact_Table";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(Fact_Table.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class Fact_tableStruct implements routines.system.IPersistableRow<Fact_tableStruct> {
		final static byte[] commonByteArrayLock_DATAWAREHOUSE_PROJECT_Fact_Table = new byte[0];
		static byte[] commonByteArray_DATAWAREHOUSE_PROJECT_Fact_Table = new byte[0];
		...
		public boolean equals(Object obj) {
			...
			if (getClass() != obj.getClass())
				return false;
			final Fact_tableStruct other = (Fact_tableStruct) obj;
		...
		public void copyDataTo(Fact_tableStruct other) {
		...
		public void copyKeysDataTo(Fact_tableStruct other) {
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_DATAWAREHOUSE_PROJECT_Fact_Table) {
		 ...
		 * Compare keys
		 */
		public int compareTo(Fact_tableStruct other) {
	...
	public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
		...
		public Integer id_date_vente;

		public Integer getId_date_vente() {
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_DATAWAREHOUSE_PROJECT_Fact_Table) {
				...
				try {
					...
					this.id_date_vente = readInteger(dis);
		...
		public void writeData(ObjectOutputStream dos) {
			try {
				...
				writeInteger(this.id_date_vente, dos);
		...
		public String toString() {
			...
			sb.append(",id_client=" + String.valueOf(id_client));
			sb.append(",quantite=" + String.valueOf(quantite));
			sb.append(",id_date_vente=" + String.valueOf(id_date_vente));
			sb.append("]");
	...
	public void tFileInputExcel_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				Fact_tableStruct Fact_table = new Fact_tableStruct();
				...
				if (execStat) {
					runStat.updateStatOnConnection(resourceMap, iterateId, 0, 0, "Fact_table");
				}
				...
				String tableName_tDBOutput_1 = "Fact_vente";
				...
				final String decryptedPassword_tDBOutput_1 = routines.system.PasswordEncryptUtil
						.decryptPassword("enc:routine.encryption.key.v1:RGNDOW1WkEvVn/nF0LVDfAkhVT62cPWLbZFpYw==");
				...
				while (rsTable_tDBOutput_1.next()) {
					...
					if (table_tDBOutput_1.equalsIgnoreCase("Fact_vente")) {
				...
				if (!whetherExist_tDBOutput_1) {
					try (java.sql.Statement stmtCreate_tDBOutput_1 = conn_tDBOutput_1.createStatement()) {
						stmtCreate_tDBOutput_1.execute("CREATE TABLE `" + tableName_tDBOutput_1
								+ "`(`id_vente` INT(200)  ,`id_client` INT(0)  ,`id_date` INT(10)  ,`id_produit` INT(0)  ,`Montant` DOUBLE ,`Quantite` INT(0)  ,primary key(`id_vente`,`id_client`,`id_date`,`id_produit`))");
					}
				}

				String insert_tDBOutput_1 = "INSERT INTO `" + "Fact_vente"
						+ "` (`id_vente`,`id_client`,`id_date`,`id_produit`,`Montant`,`Quantite`) VALUES (?,?,?,?,?,?)";
...
// # Outputs initialization
				Fact_tableStruct Fact_table_tmp = new Fact_tableStruct();
// ###############################
				...
				final String decryptedPassword_tFileInputExcel_1 = routines.system.PasswordEncryptUtil
						.decryptPassword("enc:routine.encryption.key.v1:7m1mMQefAd53AFA9qzhFDJWmB5e+TlmAcG5Q4w==");
						...
						for (int i_tFileInputExcel_1 = begin_line_tFileInputExcel_1; i_tFileInputExcel_1 < end_line_tFileInputExcel_1; i_tFileInputExcel_1++) {
							...
							try {
								...
								if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
									...
									row1.id_vente = ParserUtils.parseTo_Integer(ParserUtils.parseTo_Number(
								...
								if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
									...
									row1.id_produit = ParserUtils.parseTo_Integer(ParserUtils.parseTo_Number(
											temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1], null,
											'.' == decimalChar_tFileInputExcel_1 ? null
													: decimalChar_tFileInputExcel_1));
								} else {
								...
								if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
									...
									row1.id_client = ParserUtils.parseTo_Integer(ParserUtils.parseTo_Number(
											temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1], null,
											'.' == decimalChar_tFileInputExcel_1 ? null
													: decimalChar_tFileInputExcel_1));
								} else {
								...
								if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
									...
									row1.id_date_vente = ParserUtils.parseTo_Integer(ParserUtils.parseTo_Number(
											temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1], null,
											'.' == decimalChar_tFileInputExcel_1 ? null
													: decimalChar_tFileInputExcel_1));
								} else {
							...
							if (row1 != null) {
								...
								while ((tHash_Lookup_row2 != null && tHash_Lookup_row2.hasNext()) || forceLooprow2) { // G_TM_M_043
									...
									if (!rejectedInnerJoin_tMap_1) { // G_TM_M_020
										...
										Object exprKeyValue_row3__id_client = row1.id_client;
										if (exprKeyValue_row3__id_client == null) {
											hasCasePrimitiveKeyWithNull_tMap_1 = true;
										} else {
											row3HashKey.id_client = (int) (Integer) exprKeyValue_row3__id_client;
										}
									...
									if (tHash_Lookup_row3 != null && tHash_Lookup_row3.getCount(row3HashKey) > 1) { // G
										...
										// and it contains more one result from keys : row3.id_client = '" +
										// row3HashKey.id_client + "'");
									} // G 071
									...
									if (!rejectedInnerJoin_tMap_1) { // G_TM_M_020
										...
										Object exprKeyValue_row4__id_date = row1.id_date_vente;
									...
									if (!rejectedInnerJoin_tMap_1) { // G_TM_M_020
										...
										Object exprKeyValue_row5__id_produit = row1.id_produit;
										if (exprKeyValue_row5__id_produit == null) {
											hasCasePrimitiveKeyWithNull_tMap_1 = true;
										} else {
											row5HashKey.id_produit = (int) (Integer) exprKeyValue_row5__id_produit;
										}

										row5HashKey.id_categorie = row2.id_categorie;
									...
									if (tHash_Lookup_row5 != null && tHash_Lookup_row5.getCount(row5HashKey) > 1) { // G
										...
										// and it contains more one result from keys : row5.id_produit = '" +
										// row5HashKey.id_produit + "', row5.id_categorie = '" +
										// row5HashKey.id_categorie + "'");
									} // G 071
									...
									if (!rejectedInnerJoin_tMap_1) { // G_TM_M_020
										...
										Object exprKeyValue_row6__id_sous_categorie = row5.id_sous_categorie;
										if (exprKeyValue_row6__id_sous_categorie == null) {
											hasCasePrimitiveKeyWithNull_tMap_1 = true;
										} else {
											row6HashKey.id_sous_categorie = (int) (Integer) exprKeyValue_row6__id_sous_categorie;
										}
									...
									if (tHash_Lookup_row6 != null && tHash_Lookup_row6.getCount(row6HashKey) > 1) { // G
										...
										// and it contains more one result from keys : row6.id_sous_categorie = '" +
										// row6HashKey.id_sous_categorie + "'");
									} // G 071
...
// # Output table : 'Fact_table'
											Fact_table_tmp.id_vente = row1.id_vente;
											Fact_table_tmp.id_client = row3.id_client;
											Fact_table_tmp.id_date = row4.id_date;
											Fact_table_tmp.id_produit = row5.id_produit;
											Fact_table_tmp.Montant = row1.quantite * row5.prix_unitaire;
											Fact_table_tmp.Quantite = row1.quantite;
											Fact_table = Fact_table_tmp;
...
// Start of branch "Fact_table"
									if (Fact_table != null) {
										...
										if (Fact_table.id_vente == null) {
											pstmt_tDBOutput_1.setNull(1, java.sql.Types.INTEGER);
										} else {
											pstmt_tDBOutput_1.setInt(1, Fact_table.id_vente);
										}

										if (Fact_table.id_client == null) {
											pstmt_tDBOutput_1.setNull(2, java.sql.Types.INTEGER);
										} else {
											pstmt_tDBOutput_1.setInt(2, Fact_table.id_client);
										}

										if (Fact_table.id_date == null) {
											pstmt_tDBOutput_1.setNull(3, java.sql.Types.INTEGER);
										} else {
											pstmt_tDBOutput_1.setInt(3, Fact_table.id_date);
										}

										if (Fact_table.id_produit == null) {
											pstmt_tDBOutput_1.setNull(4, java.sql.Types.INTEGER);
										} else {
											pstmt_tDBOutput_1.setInt(4, Fact_table.id_produit);
										}

										if (Fact_table.Montant == null) {
											pstmt_tDBOutput_1.setNull(5, java.sql.Types.DOUBLE);
										} else {
											pstmt_tDBOutput_1.setDouble(5, Fact_table.Montant);
										}

										if (Fact_table.Quantite == null) {
											pstmt_tDBOutput_1.setNull(6, java.sql.Types.INTEGER);
										} else {
											pstmt_tDBOutput_1.setInt(6, Fact_table.Quantite);
										}
...
// ###############################      
				...
				if (execStat) {
					runStat.updateStat(resourceMap, iterateId, 2, 0, "Fact_table");
				}
	...
	public static class row2Struct implements routines.system.IPersistableRow<row2Struct> {
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_DATAWAREHOUSE_PROJECT_Fact_Table.length) {
					if (length < 1024 && commonByteArray_DATAWAREHOUSE_PROJECT_Fact_Table.length == 0) {
						commonByteArray_DATAWAREHOUSE_PROJECT_Fact_Table = new byte[1024];
					} else {
						commonByteArray_DATAWAREHOUSE_PROJECT_Fact_Table = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_DATAWAREHOUSE_PROJECT_Fact_Table, 0, length);
				strReturn = new String(commonByteArray_DATAWAREHOUSE_PROJECT_Fact_Table, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_DATAWAREHOUSE_PROJECT_Fact_Table, 0, length);
				strReturn = new String(commonByteArray_DATAWAREHOUSE_PROJECT_Fact_Table, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tDBInput_1 = routines.system.PasswordEncryptUtil
						.decryptPassword("enc:routine.encryption.key.v1:oazA7TJqDEgM7NFnfbf2b4NhFD4XNEoqzxpK2A==");
				...
				try {
					...
					while (rs_tDBInput_1.next()) {
						...
						row2_HashRow.nom_categorie = row2.nom_categorie;
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tDBInput_2 = routines.system.PasswordEncryptUtil
						.decryptPassword("enc:routine.encryption.key.v1:S5jJpUGT6mutSO+GlnmJc7i9edWVBuEfYP18+w==");
				...
				try {
					...
					while (rs_tDBInput_2.next()) {
						...
						if (colQtyInRs_tDBInput_2 < 1) {
							...
							row3.id_client = rs_tDBInput_2.getInt(1);
						...
						if (colQtyInRs_tDBInput_2 < 2) {
							...
							row3.nom = routines.system.JDBCUtil.getString(rs_tDBInput_2, 2, false);
						}
						if (colQtyInRs_tDBInput_2 < 3) {
							row3.ville = null;
						} else {

							row3.ville = routines.system.JDBCUtil.getString(rs_tDBInput_2, 3, false);
						}
	...
	public static class row4Struct implements routines.system.IPersistableComparableLookupRow<row4Struct> {
		...
		public void readValuesData(DataInputStream dis, ObjectInputStream ois) {
			try {
				...
				this.date_formatee = readDate(dis, ois);
		...
		public void readValuesData(DataInputStream dis, org.jboss.marshalling.Unmarshaller objectIn) {
			try {
				...
				this.date_formatee = readDate(dis, objectIn);
		...
		public void writeValuesData(DataOutputStream dos, ObjectOutputStream oos) {
			try {
				...
				writeDate(this.date_formatee, dos, oos);
		...
		public void writeValuesData(DataOutputStream dos, org.jboss.marshalling.Marshaller objectOut) {
			try {
				...
				writeDate(this.date_formatee, dos, objectOut);
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tDBInput_3 = routines.system.PasswordEncryptUtil
						.decryptPassword("enc:routine.encryption.key.v1:2XLeorN/uaht2hueNoPgI4XC1/AD1MMlwcQu/A==");
				...
				try {
					...
					while (rs_tDBInput_3.next()) {
						...
						if (colQtyInRs_tDBInput_3 < 1) {
							...
							row4.id_date = rs_tDBInput_3.getInt(1);
						...
						if (colQtyInRs_tDBInput_3 < 2) {
							...
							row4.jour = rs_tDBInput_3.getInt(2);
							if (rs_tDBInput_3.wasNull()) {
								row4.jour = null;
							}
						}
						if (colQtyInRs_tDBInput_3 < 3) {
							...
							row4.mois = rs_tDBInput_3.getInt(3);
							if (rs_tDBInput_3.wasNull()) {
								row4.mois = null;
							}
						}
						if (colQtyInRs_tDBInput_3 < 4) {
							...
							row4.annee = rs_tDBInput_3.getInt(4);
							if (rs_tDBInput_3.wasNull()) {
								row4.annee = null;
							}
						}
						if (colQtyInRs_tDBInput_3 < 5) {
							...
							row4.jour_semaine = routines.system.JDBCUtil.getString(rs_tDBInput_3, 5, false);
						}
						if (colQtyInRs_tDBInput_3 < 6) {
							...
							if (rs_tDBInput_3.getString(6) != null) {
								...
								if (!("0000-00-00").equals(dateString_tDBInput_3)
									...
									row4.date_formatee = rs_tDBInput_3.getTimestamp(6);
								} else {
									row4.date_formatee = (java.util.Date) year0_tDBInput_3.clone();
								}
							} else {
								row4.date_formatee = null;
							}
						...
						row4_HashRow.date_formatee = row4.date_formatee;
	...
	public static class row5Struct implements routines.system.IPersistableComparableLookupRow<row5Struct> {
		...
		public void readValuesData(DataInputStream dis, ObjectInputStream ois) {
			try {
				...
				this.id_sous_categorie = readInteger(dis, ois);
		...
		public void readValuesData(DataInputStream dis, org.jboss.marshalling.Unmarshaller objectIn) {
			try {
				...
				this.id_sous_categorie = readInteger(dis, objectIn);

				length = objectIn.readByte();
				if (length == -1) {
					this.prix_unitaire = null;
				} else {
					this.prix_unitaire = objectIn.readDouble();
				}
		...
		public void writeValuesData(DataOutputStream dos, ObjectOutputStream oos) {
			try {
				...
				writeInteger(this.id_sous_categorie, dos, oos);
		...
		public void writeValuesData(DataOutputStream dos, org.jboss.marshalling.Marshaller objectOut) {
			try {
				...
				writeInteger(this.id_sous_categorie, dos, objectOut);

				if (this.prix_unitaire == null) {
					objectOut.writeByte(-1);
				} else {
					objectOut.writeByte(0);
					objectOut.writeDouble(this.prix_unitaire);
				}
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tDBInput_4 = routines.system.PasswordEncryptUtil
						.decryptPassword("enc:routine.encryption.key.v1:2M5fGHMRpaf6IYu1Cl0YihiHukpq9Nb8BqjeZw==");
				...
				String url_tDBInput_4 = "jdbc:mysql://" + "localhost" + ":" + "3306" + "/" + "olap" + "?"
						+ properties_tDBInput_4;
				...
				try {
					...
					while (rs_tDBInput_4.next()) {
						...
						if (colQtyInRs_tDBInput_4 < 2) {
							row5.nom_produit = null;
						} else {

							row5.nom_produit = routines.system.JDBCUtil.getString(rs_tDBInput_4, 2, false);
						}
						if (colQtyInRs_tDBInput_4 < 3) {
							row5.marque = null;
						} else {

							row5.marque = routines.system.JDBCUtil.getString(rs_tDBInput_4, 3, false);
						}
						if (colQtyInRs_tDBInput_4 < 4) {
							row5.id_categorie = null;
						} else {

							row5.id_categorie = rs_tDBInput_4.getInt(4);
							if (rs_tDBInput_4.wasNull()) {
								row5.id_categorie = null;
							}
						}
						if (colQtyInRs_tDBInput_4 < 5) {
							...
							row5.id_sous_categorie = rs_tDBInput_4.getInt(5);
							if (rs_tDBInput_4.wasNull()) {
								row5.id_sous_categorie = null;
							}
						}
						if (colQtyInRs_tDBInput_4 < 6) {
							row5.prix_unitaire = null;
						} else {

							row5.prix_unitaire = rs_tDBInput_4.getDouble(6);
							if (rs_tDBInput_4.wasNull()) {
								row5.prix_unitaire = null;
							}
						}
						...
						row5_HashRow.nom_produit = row5.nom_produit;

						row5_HashRow.marque = row5.marque;

						row5_HashRow.id_categorie = row5.id_categorie;

						row5_HashRow.id_sous_categorie = row5.id_sous_categorie;

						row5_HashRow.prix_unitaire = row5.prix_unitaire;
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tDBInput_5 = routines.system.PasswordEncryptUtil
						.decryptPassword("enc:routine.encryption.key.v1:mb+AXgpbfYrKaQrBixI3tg7vBeTUE0kIaxZGpw==");
				...
				String url_tDBInput_5 = "jdbc:mysql://" + "localhost" + ":" + "3306" + "/" + "olap" + "?"
						+ properties_tDBInput_5;
				...
				try {
					...
					while (rs_tDBInput_5.next()) {
						...
						if (colQtyInRs_tDBInput_5 < 1) {
							row6.id_sous_categorie = 0;
						} else {

							row6.id_sous_categorie = rs_tDBInput_5.getInt(1);
							if (rs_tDBInput_5.wasNull()) {
								throw new RuntimeException("Null value in non-Nullable column");
							}
						}
						if (colQtyInRs_tDBInput_5 < 2) {
							row6.nom_sous_categorie = null;
						} else {

							row6.nom_sous_categorie = routines.system.JDBCUtil.getString(rs_tDBInput_5, 2, false);
						}
						if (colQtyInRs_tDBInput_5 < 3) {
							row6.id_categorie = null;
						} else {

							row6.id_categorie = routines.system.JDBCUtil.getString(rs_tDBInput_5, 3, false);
						}
						...
						row6_HashRow.id_sous_categorie = row6.id_sous_categorie;

						row6_HashRow.nom_sous_categorie = row6.nom_sous_categorie;

						row6_HashRow.id_categorie = row6.id_categorie;
	...
	public static void main(String[] args) {
		final Fact_Table Fact_TableClass = new Fact_Table();

		int exitCode = Fact_TableClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = Fact_Table.class.getClassLoader()
					.getResourceAsStream("datawarehouse_project/fact_table_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = Fact_Table.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : Fact_Table");
		}
...
/************************************************************************************************
 * 193073 characters generated by Talend Open Studio for Data Integration on the
 * 12 mai 2025 à 23:28:02 WEST
 ************************************************************************************************/